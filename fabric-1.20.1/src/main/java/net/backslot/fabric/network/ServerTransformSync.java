...
public final class ServerTransformSync {
    ...
    private static void send(ServerPlayer player, UUID ownerId, ActiveTransforms transforms) {
        ...
        BackSlotPackets.writeTransformSync(buffer, ownerId, transforms.backTransform(), transforms.beltTransform());
        ServerPlayNetworking.send(player, BackSlotPackets.SYNC_TRANSFORM, buffer);
    }
