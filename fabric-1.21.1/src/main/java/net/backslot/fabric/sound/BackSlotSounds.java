...
public final class BackSlotSounds {
    public static final ResourceLocation SHEATH_SWORD_ID = ResourceLocation.fromNamespaceAndPath("neobackslot", "sheath_sword");
    public static final ResourceLocation PACK_UP_ITEM_ID = ResourceLocation.fromNamespaceAndPath("neobackslot", "pack_up_item");
